...
![Original Problems 1.1 and 1.2 from Lamar](screenshots/prob_1_1_and_1_2.png)
![Original Problems 1.1 and 1.2 from Lamar](screenshots/prob_1_1_and_1_2.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 1.1
![Solution 1.1 from Lamar](screenshots/sol_1_1.png)
![Solution 1.1 from Lamar](screenshots/sol_1_1.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 1.2
![Solution 1.2 from Lamar](screenshots/sol_1_2.png)
![Solution 1.2 from Lamar](screenshots/sol_1_2.png)
...
**Original Problem:** Compute the derivative of the vector function:
$$\vec{r}(t) = \left\langle \ln(t^2 + 1),\; t\,e^{-t},\; 4 \right\rangle$$
...
$$\frac{d}{dt}\left[t\,e^{-t}\right] = e^{-t} + t(-e^{-t}) = e^{-t}(1 - t)$$
...
![Solution 2.1 from Lamar](screenshots/sol_2_1.png)
![Solution 2.1 from Lamar](screenshots/sol_2_1.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 2.2
![Solution 2.2 from Lamar](screenshots/sol_2_2.png)
![Solution 2.2 from Lamar](screenshots/sol_2_2.png)
...
**Original Problem:** Evaluate:
$$\int_{-1}^{2} \vec{r}(t)\,dt, \quad \text{where } \vec{r}(t) = \langle 6,\; 6t^2 - 4t,\; t\,e^{2t} \rangle$$
...
$$\int_{-1}^{2} 6\,dt = 6t\Big|_{-1}^{2} = 6(2) - 6(-1) = 12 + 6 = 18$$
...
$$= \frac{t\,e^{2t}}{2}\Bigg|_{-1}^{2} - \int_{-1}^{2} \frac{e^{2t}}{2}\,dt$$

$$= \frac{t\,e^{2t}}{2}\Bigg|_{-1}^{2} - \frac{e^{2t}}{4}\Bigg|_{-1}^{2}$$
...
![Original Problems 3.1 and 3.2 from Lamar](screenshots/prob_3_1_and_3_2.png)
![Original Problems 3.1 and 3.2 from Lamar](screenshots/prob_3_1_and_3_2.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 3.1
![Solution 3.1 from Lamar](screenshots/sol_3_1.png)
![Solution 3.1 from Lamar](screenshots/sol_3_1.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 3.2
![Solution 3.2 from Lamar](screenshots/sol_3_2.png)
![Solution 3.2 from Lamar](screenshots/sol_3_2.png)
...
### 📸 Screenshot โจทย์ต้นฉบับ (Problems 1 & 2)
![Original Problems 4.1 and 4.2 from Lamar](screenshots/prob_4_1_and_4_2.png)
![Original Problems 4.1 and 4.2 from Lamar](screenshots/prob_4_1_and_4_2.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 4.1
![Solution 4.1 from Lamar](screenshots/sol_4_1.png)
![Solution 4.1 from Lamar](screenshots/sol_4_1.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 4.2
![Solution 4.2 from Lamar](screenshots/sol_4_2.png)
![Solution 4.2 from Lamar](screenshots/sol_4_2.png)
...
The curvature formula is: $\kappa = \dfrac{||\vec{r}\,'(t) \times \vec{r}\,''(t)||}{||\vec{r}\,'(t)||^3}$
...
### 📸 Screenshot โจทย์ต้นฉบับ (Problems 1 & 2)
![Original Problems 5 and 6 from Lamar](screenshots/prob_5_and_6.png)
![Original Problems 5 and 6 from Lamar](screenshots/prob_5_and_6.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 5.1
![Solution 5.1 from Lamar](screenshots/sol_5_1.png)
![Solution 5.1 from Lamar](screenshots/sol_5_1.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 5.2 (Lesson Example)
![Solution 5.2 from Lamar Lesson](screenshots/sol_5_2.png)
![Solution 5.2 from Lamar Lesson](screenshots/sol_5_2.png)
...
![Solution 6.1 from Lamar](screenshots/sol_6_1.png)
![Solution 6.1 from Lamar](screenshots/sol_6_1.png)

### 📸 Screenshot เฉลยต้นฉบับ Problem 6.2 (Lesson Example)
![Solution 6.2 from Lamar Lesson](screenshots/sol_6_2.png)
![Solution 6.2 from Lamar Lesson](screenshots/sol_6_2.png)
...
$$\vec{v}(t) = \left\langle \frac{3t^2}{2},\; 4e^{-t} - 3,\; 4t^3 - 3 \right\rangle$$
...
$$\vec{r}(t) = \left\langle \frac{t^3}{2} - 5,\; -4e^{-t} - 3t + 6,\; t^4 - 3t - 3 \right\rangle$$
...
$$\vec{r}(t) = \langle \frac{t^2}{2} + 1,\; t^2 + t - 2,\; t^3 - t + 3 \rangle$$
